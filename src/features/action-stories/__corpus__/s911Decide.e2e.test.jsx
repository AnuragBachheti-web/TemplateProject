...
import fixture from './fixtures/raw/S9.11/decide.json';
...
// One level deeper than before: this suite moved into __corpus__/ when the 105 story manifests and
// fixtures were archived there (they are reference evidence, not runtime templates).
